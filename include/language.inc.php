        ...
        if (!setlocale(LC_ALL, $locale)) {
            if ($unicode_encoding) {
                if (setlocale(LC_ALL, 'fr_FR.UTF8') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'fr_FR.UTF8') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'fr-UTF8') == true) {
                    $ok = 'yes';
                }
            } else {
                if (setlocale(LC_ALL, 'fr_FR.ISO8859-1') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'French') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'france') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'fra') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'french') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'FR') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'fr_FR') == true) {
                    $ok = 'yes';
                } elseif (setlocale(LC_ALL, 'fr_FR@euro') == true) {
                    $ok = 'yes';
                }
            }
        }
...
function get_server_os()
{
    if (stristr(PHP_OS, 'Darwin')) {
        ...
        return 'windows';
    } elseif (stristr(PHP_OS, 'ux') || stristr(PHP_OS, 'BSD')) {
        return 'unix';
    } else {
        return 'unsupported';
    }
...
/* todo pourquoi cette vérif est faite dans language ? le mettre ailleurs, dans init peut être */
